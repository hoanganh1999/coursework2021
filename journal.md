...
## 15/11/2020
I had a problem with my character when it doesn't move at all even when I presses the W, A, S, D keys. My character couldn't move because I didn't inrease the value of the speed variable. I managed to fix this problem by goin in the script and change the value of the speed valuble after that my character wa able to move.
